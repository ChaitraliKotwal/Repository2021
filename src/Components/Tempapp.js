...
<div class="container">
<br></br>
<center><div class="row align-items-center h-100">
    <div class="col-5 mx-auto">
      <div class="card card-1">
        <h3>React Weather App</h3><br></br>
     ...
     {!city ? (
        ...
        <div className="info">
          ...
          <h5 className="tempmin_max">Max : {city.temp_max}°Cel | Min : {city.temp_min}°Cel</h5>
           <h5 className="tempph">Pressure : {city.pressure} | Humidity : {city.humidity}</h5>
       </div>
       )}
        </div>
      </div>
